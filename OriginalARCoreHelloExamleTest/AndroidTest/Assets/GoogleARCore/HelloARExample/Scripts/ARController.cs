...
namespace GoogleARCore.HelloAR
{
    ...
    public class ARController : MonoBehaviour
    {
        ...
        public List<GameObject> Keyparts = new List<GameObject>();
        ...
        public void Update ()
        {
            ...
            */
            ...
            if (Physics.Raycast(m_firstPersonCamera.ScreenPointToRay(touch.position), out hitnormal))
            {
                if(hitnormal.transform.tag == "keypart")
                {
                    Destroy(hitnormal.transform.gameObject);
                }
            }
